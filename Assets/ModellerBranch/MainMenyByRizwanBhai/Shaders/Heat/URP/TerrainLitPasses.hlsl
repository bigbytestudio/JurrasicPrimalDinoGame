...
#ifdef TERRAIN_SPLAT_ADDPASS
    half heatAlpha = alpha;
#else
    half heatAlpha = 1.0h;
#endif
    half4 color = UniversalFragmentPBR(inputData, albedo, metallic, half3(0.0h, 0.0h, 0.0h), smoothness, /* occlusion */ 1.0, /* emission */ half3(0, 0, 0), heatAlpha);
